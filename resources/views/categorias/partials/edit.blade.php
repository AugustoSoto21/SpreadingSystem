          ...
          <div class="row">
            <div class="col-sm-10">
              <div class="form-group">
                ...
                <input type="text" name="categoria" id="categoria_edit" class="form-control" required="required" placeholder="Ingrese el nombre del categoría" onkeyup="this.value = this.value.toUpperCase();">
              </div>
              @error('categoria')

<div class="modal fade" id="create_clientes">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="{{ route('clientes.store') }}" method="POST" data-parsley-validate>
        @csrf
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <textarea name="direccion" id="direccion" class="form-control" required="required" placeholder="Ingrese la dirección del cliente" onkeyup="this.value = this.value.toUpperCase();" rows="6" cols="10"></textarea>
              </div>
              @error('direccion')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror

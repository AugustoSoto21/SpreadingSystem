@extends('layouts.app')
@section('title') Actualizar de Pedido @endsection
@section('content')
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Actualizar de Pedido</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
$("#id_producto").on('select2:select',function (event) {
    ...
    if (id_producto!="" && id_cliente!="") {
      $.get('/pedidos/'+id_producto+'/'+id_cliente+'/'+codigo+'/llenar_carrito2',function (data) {})
        .done(function(data) {
          //console.log(data);        
...
function change_amount(cantidad, id_producto){
    ...
    $.get('/pedidos/'+nueva_cantidad+'/'+id_producto+'/'+codigo+'/actualizar_cantidad_producto2',function (data) {})
    .done(function(data) {
      var porcentaje_descuento;
      var monto_descuento;
      var total_fact;
...
function change_cost(costo, id_producto){
    ...
    var codigo=$("#codigo").val();
    $.get('/pedidos/'+nuevo_costo+'/'+id_producto+'/'+codigo+'/actualizar_costo_producto2',function (data) {})
    .done(function(data) {
      var porcentaje_descuento;
      var monto_descuento;
      var total_fact;
  ...
  function change_porcentaje_descuento(monto){
    var nuevo_monto=monto.value;
    var codigo=$("#codigo").val();
    $.get('/pedidos/'+nuevo_monto+'/'+codigo+'/actualizar_porcentaje_descuento2',function (data) {})
    .done(function(data) {
...
function calcular_recargo(id_cuota) {
  //console.log(id_cuota.value);
    ...
    var codigo=$("#codigo").val();
    $.get('/pedidos/'+id_cuota.value+'/'+monto+'/'+codigo+'/calcular_recargo2',function (data) {})
    .done(function(data) {
...
$("#id_medio").on('change',function (event) {
  ...
  function anular_pago_ct(opcion) {
    var codigo=$("#codigo").val();
    $.get('/pedidos/0/0/'+codigo+'/calcular_recargo2',function (data) {})
    .done(function(data) {
  ...
  function agregar_tarifa_envio(opcion) {
    ...
    var codigo=$("#codigo").val();
    $.get('/pedidos/'+monto+'/'+opcion+'/'+codigo+'/agregar_tarifa_envio2',function (data) {})
    .done(function(data) {
  ...
  function agregar_tarifa_envio_agencia(opcion) {
    ...
    $.get('/pedidos/'+id_tarifa+'/'+opcion+'/'+codigo+'/agregar_tarifa_envio_agencia2',function (data) {})
    .done(function(data) {
      //console.log(data);
        if(data.length > 0){
          $("#total").text(formatNumber(data[0].total_fact.toFixed(2)));

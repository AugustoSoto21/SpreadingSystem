...
class PartidosZonasTablesSeeder extends Seeder
{
    ...
    public function run()
    {
        \DB::table('partidos')->insert([
        	...
        	['partido' => 'Moreno'],//13
        	['partido' => 'Merlo'],//14
        	['partido' => 'Avellaneda'],//15
        	['partido' => 'Lanús'],//16
        	['partido' => 'Lomas d Zamora'],//17
        	['partido' => 'Quilmes'],//18
        	['partido' => 'Almirante Brown'],//19
        	['partido' => 'Esteban Echeverría'],//20
        	['partido' => 'Ezeiza'],//21
        	['partido' => 'Berazategui'],//22
        	['partido' => 'Florencio Varela'],//23
        	['partido' => 'Buenos Aires'],//24
        	['partido' => 'Cañuelas'],//25
        	['partido' => 'Ensenada'],//26
        	['partido' => 'Berisso'],//27
        	['partido' => 'Campana'],//28
        	['partido' => 'Cnel. Brandsen'],//29
        	['partido' => 'Ex. de la Cruz'],//30
        	['partido' => 'Gral. Las Heras'],//31
        	['partido' => 'Luján'],//32
        	['partido' => 'Marcos Paz'],//33
        	['partido' => 'Presidente Perón'],//34
        	['partido' => 'San Vicente'],//35
        	['partido' => 'Zárate'],//36
        	['partido' => 'La Plata']//37
        ]
        );
